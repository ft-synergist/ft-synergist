...
export default function ContactPage() {
    ...
    // Mapped URLs from official Google Calendar embeds
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        // 2. Wrap window.open in setTimeout to bypass aggressive popup blockers
    ...
    return (
        <div className="min-h-screen bg-black text-white antialiased font-sans w-full overflow-x-hidden relative">
            {/* HERO & FORM SECTION */}
            <section className="pt-36 pb-20 px-4 sm:px-6 lg:px-8 min-h-screen flex flex-col justify-center">
                <div className="max-w-5xl mx-auto space-y-12">
                    ...
                    <div className="text-center space-y-4">
                        ...
                        <p className="text-xl sm:text-2xl text-[#8F801B] font-medium max-w-3xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 text-gray-300">
                        <div className="bg-white/5 border border-white/10 p-5 rounded-xl space-y-2">
                            ...
                            <p className="text-xs font-bold text-[#8F801B]">— Brandon Toh, Branwood Holdings</p>
                        </div>
                        ...
                        <div className="bg-white/5 border border-white/10 p-5 rounded-xl space-y-2">
                            ...
                            <p className="text-xs font-bold text-[#8F801B]">— Paul Chen, Sundat (S) Pte Ltd</p>
                        </div>
                        ...
                        <div className="bg-white/5 border border-white/10 p-5 rounded-xl space-y-2">
                            ...
                            <p className="text-xs font-bold text-[#8F801B]">— Thina Nguyen, Mei Le Pte Ltd</p>
                        </div>
                        ...
                        <div className="bg-white/5 border border-white/10 p-5 rounded-xl space-y-2">
                            ...
                            <p className="text-xs font-bold text-[#8F801B]">— Rosemary Kwa, Petale Tea</p>
                        </div>

                        <div className="bg-white/5 border border-white/10 p-5 rounded-xl space-y-2 md:col-span-2 lg:col-span-2">
                            ...
                            <p className="text-xs font-bold text-[#8F801B]">— Hidayah, Nanay’s Kitchen</p>
                        </div>
                    </div>

                    {/* CONVERSION FORM & EMBEDDED FALLBACK */}
                    <div className="bg-white text-slate-900 rounded-2xl p-6 sm:p-10 shadow-2xl max-w-3xl mx-auto border border-[#8F801B]/30">
                        {!isFormSubmitted ? (
                            <form onSubmit={handleSubmit} className="space-y-5">
                                <h3 className="text-xl font-bold text-slate-900 border-b pb-3 font-heading">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className="w-full border border-slate-300 rounded-lg p-3 text-sm focus:ring-2 focus:ring-[#8F801B] outline-none"
                                ...
                                <div>
                                    ...
                                    <select
                                        ...
                                        className="w-full border border-slate-300 rounded-lg p-3 text-sm focus:ring-2 focus:ring-[#8F801B] outline-none bg-white font-medium"
                                ...
                                <button
                                    type="submit"
                                    className="w-full bg-[#8F801B] hover:bg-[#7a6c16] text-white font-bold py-4 rounded-lg text-base transition-colors shadow-lg cursor-pointer"
                                >
                            ...
                            <div className="text-center space-y-6">
                                ...
                                <a
                                    ...
                                    className="inline-block bg-[#8F801B] hover:bg-[#7a6c16] text-white font-bold py-3 px-6 rounded-lg text-sm transition-all"
                                >
